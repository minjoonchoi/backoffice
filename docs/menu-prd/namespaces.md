...
| ---------- | --------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| NSP-SCN-01 | 네임스페이스 목록 view 권한       | key·이름·관리 역할·상태·동기화 시각으로 조회하고 행으로 상세에 진입한다.                    | `UIR-001`, `UIR-020`            | 권한 범위 namespace filter·pagination·정상/고아·동기화 통계 (`UIR-S001`, `UIR-S005`, `UIR-S008`)                     | ![목록](assets/namespaces-list.png)             |
...
| NSP-SCN-03 | 상세 view 권한                    | 관리 역할과 역할 부여 조직, 정상·고아 리소스 수, 마지막 동기화와 이력을 조회한다.           | `UIR-020`, `UIR-021`            | namespace·관리 역할·독립 sync history query와 스냅샷 통계 (`UIR-S008~009`)                                           | ![상세](assets/namespaces-detail.png)           |
